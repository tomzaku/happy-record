...
import styles from './WeekView.mobile.module.scss';
  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        <Icon onClick={handlePrevWeek} width={22} icon="basil:skip-prev-outline" className={styles.navIcon} />
        <Typography.Text
        ...
        <Icon onClick={handleNextWeek} width={22} icon="basil:skip-next-outline" className={styles.navIcon} />
      </div>
          ...
          return (
            ...
            >
              <div className={styles.dayInfo}>
                ...
                <Typography.Title level={5} noMargin className={styles.dayNumber}>
                  {format(date, 'd')}
                </Typography.Title>
              </div>
