  ...
  return createPortal(
    <div className={styles.overlay} onClick={closeOnOverlayClick ? onDismiss : undefined}>
      {/* stopPropagation only — this used to also call preventDefault(), which doesn't do
          ...
          preventDefault() — which is exactly what made a checkbox inside this modal (CardShare's
          own "Allow comments" checkbox, before it moved elsewhere) silently fail to check/uncheck. */}
