...
const baseOptions = {
  ...
  greetingText: null,
  startWidgetLayout: 'countdown' as const,
  greetingWidgetLayout: 'heading' as const,
  targetsWidgetLayout: 'list' as const,
  buttonWidgetLayout: 'plain' as const,
  titleWidgetLayout: 'row' as const,
  pageBackgroundLayout: 'solid' as const,
  pageBackgroundImageUrl: null,
  glassOpacity: 12,
  checkinsChartType: 'bar' as const,
