// Request-scoped ctx shape + tiny body-parsing helper every field-group-completions/api handler
// needs. Kept local rather than promoted to `shared/` since nothing outside this resource needs
// them — see flags/api's own version of this file for the reference shape.
